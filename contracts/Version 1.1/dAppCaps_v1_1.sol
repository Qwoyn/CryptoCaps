	...
	*/
	...
	contract dAppCaps is ERC721Token, Ownable, Fallback, ERC1412 {
	  ...
	  string public constant version = "Version 1.0";

	  
	  uint8 constant TITLE_MAX_LENGTH = 64;
	  uint256 constant DESCRIPTION_MAX_LENGTH = 1000;
	  ...
	  mapping(uint256 => string)  physicalLocations;
	  ...
	  function buyToken (
		...
		physicalLocations[index] = _physicalLocation;
		materials[index]         = _materials;
	  ...
	  function viewTokenMeta(uint256 _tokenId)
		...
		returns (
		  ...
		  physicalLocation_ = physicalLocations[_tokenId];
		  materials_ 		= materials[_tokenId];
